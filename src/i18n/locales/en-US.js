...
export default {
  ...
  moment: {
    ...
    calendar: {
      ...
      nextWeek: '{{dayNextWeek}} at {{time}}',
      lastDay: 'Yesterday at {{time}}',
      lastWeek: 'Last {{dayLastWeek}} at {{time}}',
    },
    relativeTime: {
      future: 'in {{timeInFuture}}',
      past: '{{timeInPast}} ago',
      s: 'a few seconds',
      ss: '{{numberOfSeconds}} seconds',
      m: 'one minute',
      mm: '{{numberOfMinutes}} minutes',
      h: 'one hour',
      hh: '{{numberOfHours}} minutes',
      d: 'one day',
      dd: '{{numberOfDays}} days',
      M: 'one month',
      MM: '{{numberOfMonths}} months',
      y: 'one year',
      yy: '{{numberOfyears}} years',
    },
  },
  mainTabs: {
