    ...
    const menuItems = [
      ...
      showFollowupStatus
        ? {
            ...
            action: () =>
              dispatch(
                updateFollowupStatus(person, orgPermission.id, 'completed'),
              ),
      ...
      showFollowupStatus
        ? {
            ...
            action: () =>
              dispatch(
                updateFollowupStatus(person, orgPermission.id, 'contacted'),
              ),
      ...
      showFollowupStatus
        ? {
            ...
            action: () =>
              dispatch(
                updateFollowupStatus(person, orgPermission.id, 'uncontacted'),
              ),
