...
describe('post formatting', () => {
  it('renders today', () => {
    renderWithContext(
      <DateComponent date={'2018-06-11 12:00:00'} postFormatting={true} />,
    ).snapshot();
  });

  it('renders yesterday', () => {
    renderWithContext(
      <DateComponent date={'2018-06-10 12:00:00'} postFormatting={true} />,
    ).snapshot();
  });

  it('renders date from last week', () => {
    renderWithContext(
      <DateComponent date={'2018-06-09 12:00:00'} postFormatting={true} />,
    ).snapshot();
    renderWithContext(
      <DateComponent date={'2018-06-07 12:00:00'} postFormatting={true} />,
    ).snapshot();
    renderWithContext(
      <DateComponent date={'2018-06-04 12:00:00'} postFormatting={true} />,
    ).snapshot();
  });

  it('renders from this year', () => {
    renderWithContext(
      <DateComponent date={'2018-06-03 12:00:00'} postFormatting={true} />,
    ).snapshot();
    renderWithContext(
      <DateComponent date={'2018-05-23 12:00:00'} postFormatting={true} />,
    ).snapshot();
  });

  it('renders from before this year', () => {
    renderWithContext(
      <DateComponent date={'2017-12-31 12:00:00'} postFormatting={true} />,
    ).snapshot();
    renderWithContext(
      <DateComponent date={'2005-02-14 12:00:00'} postFormatting={true} />,
    ).snapshot();
  });
});
