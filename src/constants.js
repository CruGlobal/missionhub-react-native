...
export const ORGANIZATION_CONTACTS_SEARCH = 'app/ORGANIZATION_CONTACTS_SEARCH';
export const SURVEY_CONTACTS_SEARCH = 'app/SURVEY_CONTACTS_SEARCH';
export const RESET_ORGANIZATION_CONTACTS = 'app/ORGANIZATION_CONTACTS_CLEAR';
export const RESET_SURVEY_CONTACTS = 'app/SURVEY_CONTACTS_CLEAR';
